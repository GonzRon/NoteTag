package com.loosecannon.notetag.core.links

// Copied from ServiceTag's core/links/LinkLaunchPolicy.kt (8a94872 lineage) on purpose: the policy is a product decision, not a library mechanism (target §4.7).

/** Copied alongside the policy: ServiceTag's model.LinkKind (dc1bb1c/f92a391 lineage) lives here, not in a shared module. */
