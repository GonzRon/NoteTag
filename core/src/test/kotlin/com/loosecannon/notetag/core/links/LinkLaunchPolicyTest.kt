...
class LinkLaunchPolicyTest {
    ...
    @Test fun aControlCharacterInsideTheUriIsRejected() {
        assertIs<LinkCheck.Rejected>(LinkLaunchPolicy.check("joplin://x\u0000y"))
    }
    @Test fun anInnerSpaceIsRejected() {
        assertIs<LinkCheck.Rejected>(LinkLaunchPolicy.check("https://a b"))
    }
}
